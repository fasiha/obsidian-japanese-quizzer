...
import { summarizeWord, openQuizDb, projectRoot, JMDICT_DB, QUIZ_SESSION } from './shared.mjs';
...
if (words.length !== ids.length) {
  ...
  console.error(`Warning: could not find JMDict entries for IDs: ${missing.join(', ')}`);
}
